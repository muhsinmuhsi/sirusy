          ...
          filteredProducts.map((data) => (
            ...
            >
              ...
              <div className="flex justify-center border rounded">
                <img className="rounded h-44 object-fill" src={data.image} alt={data.title} />
              </div>
              ...
              <div className="flex flex-col items-center mt-2">
                ...
                <button
                  className="border border-black px-2 py-1 rounded-lg hover:scale-105 transition-all mt-2"
                >
                  <Plus/>
                </button>
              </div>
