...
const AdminHome = () => {
  ...
  // const totalProducts = 0 // You can replace this with dynamic data later
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
      <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-3xl text-center">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center">
          ...
          <button onClick={()=>navigate('/admin/AddBannerImage')} className="w-full md:w-1/2 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-6 rounded-2xl text-xl shadow-md transition duration-300">
            Add BannerImage
          </button>
        </div>
      </div>
